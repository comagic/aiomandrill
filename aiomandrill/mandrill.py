...
class Mandrill:
    def __init__(self, apikey=None, debug=False):
       ...
       '''
        ...
        if apikey is None:
            raise Error('You must provide a Mandrill API key')
        self.apikey = apikey
    ...
    @asyncio.coroutine
    def call(self, url, params=None, ioloop=None):
        '''Actually make the API call with the given params - this should only be called
        by the namespace methods - use the helpers in regular usage like m.tags.list()
        '''
        params = params or {}
        ...
        start = time.time()
        headers = {'content-type': 'application/json', 'user-agent': 'aiomandrill/0.1'}
        with aiohttp.ClientSession(loop=ioloop) as client:
            try:
                r = yield from client.post(
                    '%s%s.json' % (ROOT, url),
                    data=params,
                    headers=headers)
                response_body = yield from r.text()
            finally:
                r.close()
        complete_time = time.time() - start
        self.log('Received %s in %.2fms: %s' % (r.status, complete_time * 1000, response_body))
    ...
    def cast_error(self, result):
        '''Take a result representing an error and cast it to a specific exception if possible
        (use a generic mandrill.Error exception for unknown cases)
        '''
        if 'status' not in result or result['status'] != 'error' or 'name' not in result:
...
class Templates(object):
    ...
    @asyncio.coroutine
    def add(self, name, from_email=None, from_name=None, subject=None,
            code=None, text=None, publish=True, labels=[], ioloop=None):
        """Add a new template
        ...
        return (yield from self.master.call('templates/add', _params, ioloop=ioloop))

    @asyncio.coroutine
    def info(self, name, ioloop=None):
        ...
        """
        _params = {'name': name}
        return (yield from self.master.call('templates/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def update(self, name, from_email=None, from_name=None, subject=None,
               code=None, text=None, publish=True, labels=None, ioloop=None):
        ...
        return (yield from self.master.call('templates/update', _params, ioloop=ioloop))

    @asyncio.coroutine
    def publish(self, name, ioloop=None):
        """Publish the content for the template. Any new messages sent using this template
        will start using the content that was previously in draft.
        ...
        """
        _params = {'name': name}
        return (yield from self.master.call('templates/publish', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete(self, name, ioloop=None):
        """Delete a template
        ...
        """
        _params = {'name': name}
        return (yield from self.master.call('templates/delete', _params, ioloop=ioloop))

    @asyncio.coroutine
    def list(self, label=None, ioloop=None):
        ...
        """
        _params = {'label': label}
        return (yield from self.master.call('templates/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def time_series(self, name, ioloop=None):
        ...
        """
        _params = {'name': name}
        return (yield from self.master.call('templates/time-series', _params, ioloop=ioloop))

    @asyncio.coroutine
    def render(self, template_name, template_content, merge_vars=None, ioloop=None):
        ...
        return (yield from self.master.call('templates/render', _params, ioloop=ioloop))


class Exports(object):
    def __init__(self, master, ioloop=None):
        self.master = master
...
for that job type.
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('exports/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def list(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('exports/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def rejects(self, notify_email=None, ioloop=None):
...
reason, detail, created_at, expires_at, last_event_at, expires_at.
        ...
        return (yield from self.master.call('exports/rejects', _params, ioloop=ioloop))

    @asyncio.coroutine
    def whitelist(self, notify_email=None, ioloop=None):
...
email, detail, created_at.
        ...
        """
        _params = {'notify_email': notify_email}
        return (yield from self.master.call('exports/whitelist', _params, ioloop=ioloop))

    @asyncio.coroutine
    def activity(self, notify_email=None, date_from=None, date_to=None,
                 tags=None, senders=None, states=None, api_keys=None, ioloop=None):
...
metadata fields, they will be included in the exported data.
        ...
        return (yield from self.master.call('exports/activity', _params, ioloop=ioloop))
...
class Users(object):
    ...
    def info(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('users/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def ping(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('users/ping', _params, ioloop=ioloop))

    @asyncio.coroutine
    def ping2(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('users/ping2', _params, ioloop=ioloop))

    @asyncio.coroutine
    def senders(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('users/senders', _params, ioloop=ioloop))
...
class Rejects(object):
    ...
    @asyncio.coroutine
    def add(self, email, comment=None, subaccount=None, ioloop=None):
...
address that has been whitelisted will have no effect.
        ...
        return (yield from self.master.call('rejects/add', _params, ioloop=ioloop))

    @asyncio.coroutine
    def list(self, email=None, include_expired=False, subaccount=None, ioloop=None):
...
include_expired to true to include them.
        ...
        return (yield from self.master.call('rejects/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete(self, email, subaccount=None, ioloop=None):
...
has an affect on your reputation.
        ...
        return (yield from self.master.call('rejects/delete', _params, ioloop=ioloop))
...
class Inbound(object):
    ...
    def domains(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('inbound/domains', _params, ioloop=ioloop))

    @asyncio.coroutine
    def add_domain(self, domain, ioloop=None):
        ...
        return (yield from self.master.call('inbound/add-domain', _params, ioloop=ioloop))

    @asyncio.coroutine
    def check_domain(self, domain, ioloop=None):
        ...
        """
        _params = {'domain': domain}
        return (yield from self.master.call('inbound/check-domain', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete_domain(self, domain, ioloop=None):
        ...
        """
        _params = {'domain': domain}
        return (yield from self.master.call('inbound/delete-domain', _params, ioloop=ioloop))

    @asyncio.coroutine
    def routes(self, domain, ioloop=None):
        ...
        """
        _params = {'domain': domain}
        return (yield from self.master.call('inbound/routes', _params, ioloop=ioloop))

    @asyncio.coroutine
    def add_route(self, domain, pattern, url, ioloop=None):
        ...
        return (yield from self.master.call('inbound/add-route', _params, ioloop=ioloop))

    @asyncio.coroutine
    def update_route(self, id, pattern=None, url=None, ioloop=None):
        ...
        return (yield from self.master.call('inbound/update-route', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete_route(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('inbound/delete-route', _params, ioloop=ioloop))

    @asyncio.coroutine
    def send_raw(self, raw_message, to=None, mail_from=None,
                 helo=None, client_address=None, ioloop=None):
        ...
        return (yield from self.master.call('inbound/send-raw', _params, ioloop=ioloop))
...
class Tags(object):
    ...
    def list(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('tags/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete(self, tag, ioloop=None):
...
undo this operation, so use it carefully.
        ...
        """
        _params = {'tag': tag}
        return (yield from self.master.call('tags/delete', _params, ioloop=ioloop))

    @asyncio.coroutine
    def info(self, tag, ioloop=None):
        ...
        """
        _params = {'tag': tag}
        return (yield from self.master.call('tags/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def time_series(self, tag, ioloop=None):
        ...
        """
        _params = {'tag': tag}
        return (yield from self.master.call('tags/time-series', _params, ioloop=ioloop))

    @asyncio.coroutine
    def all_time_series(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('tags/all-time-series', _params, ioloop=ioloop))
...
class Messages(object):
    ...
    @asyncio.coroutine
    def send(self, message, async=False, ip_pool=None, send_at=None, ioloop=None):
        ...
        return (yield from self.master.call('messages/send', _params, ioloop=ioloop))

    @asyncio.coroutine
    def send_template(self, template_name, template_content, message,
                      async=False, ip_pool=None, send_at=None, ioloop=None):
        ...
        return (yield from self.master.call('messages/send-template', _params, ioloop=ioloop))

    @asyncio.coroutine
    def search(self, query='*', date_from=None, date_to=None, tags=None,
               senders=None, api_keys=None, limit=100, ioloop=None):
        ...
        return (yield from self.master.call('messages/search', _params, ioloop=ioloop))

    @asyncio.coroutine
    def search_time_series(self, query='*', date_from=None, date_to=None,
                           tags=None, senders=None, ioloop=None):
        ...
        return (yield from self.master.call('messages/search-time-series', _params, ioloop=ioloop))

    @asyncio.coroutine
    def info(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('messages/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def content(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('messages/content', _params, ioloop=ioloop))

    @asyncio.coroutine
    def parse(self, raw_message, ioloop=None):
        ...
        return (yield from self.master.call('messages/parse', _params, ioloop=ioloop))

    @asyncio.coroutine
    def send_raw(self, raw_message, from_email=None, from_name=None, to=None, async=False,
                 ip_pool=None, send_at=None, return_path_domain=None, ioloop=None):
        ...
        return (yield from self.master.call('messages/send-raw', _params, ioloop=ioloop))

    @asyncio.coroutine
    def list_scheduled(self, to=None, ioloop=None):
        ...
        """
        _params = {'to': to}
        return (yield from self.master.call('messages/list-scheduled', _params, ioloop=ioloop))

    @asyncio.coroutine
    def cancel_scheduled(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('messages/cancel-scheduled', _params, ioloop=ioloop))

    @asyncio.coroutine
    def reschedule(self, id, send_at, ioloop=None):
        ...
        return (yield from self.master.call('messages/reschedule', _params, ioloop=ioloop))
...
automatically.
        ...
        return (yield from self.master.call('whitelists/add', _params, ioloop=ioloop))

    @asyncio.coroutine
    def list(self, email=None, ioloop=None):
...
address or search prefix to limit the results. Returns up to 1000 results.
        ...
        """
        _params = {'email': email}
        return (yield from self.master.call('whitelists/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete(self, email, ioloop=None):
        ...
        """
        _params = {'email': email}
        return (yield from self.master.call('whitelists/delete', _params, ioloop=ioloop))
...
class Ips(object):
    ...
    def list(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('ips/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def info(self, ip, ioloop=None):
        ...
        """
        _params = {'ip': ip}
        return (yield from self.master.call('ips/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def provision(self, warmup=False, pool=None, ioloop=None):
...
are processed within 24 hours.
        ...
        return (yield from self.master.call('ips/provision', _params, ioloop=ioloop))

    @asyncio.coroutine
    def start_warmup(self, ip, ioloop=None):
...
will be sent over shared IPs or other dedicated IPs in the same pool.
        ...
        """
        _params = {'ip': ip}
        return (yield from self.master.call('ips/start-warmup', _params, ioloop=ioloop))

    @asyncio.coroutine
    def cancel_warmup(self, ip, ioloop=None):
        ...
        """
        _params = {'ip': ip}
        return (yield from self.master.call('ips/cancel-warmup', _params, ioloop=ioloop))

    @asyncio.coroutine
    def set_pool(self, ip, pool, create_pool=False, ioloop=None):
        ...
        return (yield from self.master.call('ips/set-pool', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete(self, ip, ioloop=None):
        ...
        """
        _params = {'ip': ip}
        return (yield from self.master.call('ips/delete', _params, ioloop=ioloop))

    @asyncio.coroutine
    def list_pools(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('ips/list-pools', _params, ioloop=ioloop))

    @asyncio.coroutine
    def pool_info(self, pool, ioloop=None):
        ...
        """
        _params = {'pool': pool}
        return (yield from self.master.call('ips/pool-info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def create_pool(self, pool, ioloop=None):
...
name, no action will be performed.
        ...
        """
        _params = {'pool': pool}
        return (yield from self.master.call('ips/create-pool', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete_pool(self, pool, ioloop=None):
        ...
        """
        _params = {'pool': pool}
        return (yield from self.master.call('ips/delete-pool', _params, ioloop=ioloop))

    @asyncio.coroutine
    def check_custom_dns(self, ip, domain, ioloop=None):
...
DNS for a dedicated IP.
        ...
        return (yield from self.master.call('ips/check-custom-dns', _params, ioloop=ioloop))

    @asyncio.coroutine
    def set_custom_dns(self, ip, domain, ioloop=None):
        ...
        """
        _params = {'ip': ip, 'domain': domain}
        return (yield from self.master.call('ips/set-custom-dns', _params, ioloop=ioloop))
...
class Subaccounts(object):
    ...
    @asyncio.coroutine
    def list(self, q=None, ioloop=None):
        ...
        """
        _params = {'q': q}
        return (yield from self.master.call('subaccounts/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def add(self, id, name=None, notes=None, custom_quota=None, ioloop=None):
        ...
        return (yield from self.master.call('subaccounts/add', _params, ioloop=ioloop))
    ...
    def info(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('subaccounts/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def update(self, id, name=None, notes=None, custom_quota=None, ioloop=None):
        ...
        """
        _params = {'id': id, 'name': name, 'notes': notes, 'custom_quota': custom_quota}
        return (yield from self.master.call('subaccounts/update', _params, ioloop=ioloop))

    @asyncio.coroutine
    def delete(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('subaccounts/delete', _params, ioloop=ioloop))

    @asyncio.coroutine
    def pause(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('subaccounts/pause', _params, ioloop=ioloop))

    @asyncio.coroutine
    def resume(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('subaccounts/resume', _params, ioloop=ioloop))
...
class Urls(object):
    ...
    def list(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('urls/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def search(self, q, ioloop=None):
        ...
        """
        _params = {'q': q}
        return (yield from self.master.call('urls/search', _params, ioloop=ioloop))

    @asyncio.coroutine
    def time_series(self, url, ioloop=None):
        ...
        """
        _params = {'url': url}
        return (yield from self.master.call('urls/time-series', _params, ioloop=ioloop))

    @asyncio.coroutine
    def tracking_domains(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('urls/tracking-domains', _params, ioloop=ioloop))

    @asyncio.coroutine
    def add_tracking_domain(self, domain, ioloop=None):
        ...
        """
        _params = {'domain': domain}
        return (yield from self.master.call('urls/add-tracking-domain', _params, ioloop=ioloop))

    @asyncio.coroutine
    def check_tracking_domain(self, domain, ioloop=None):
        ...
        """
        _params = {'domain': domain}
        return (yield from self.master.call('urls/check-tracking-domain', _params, ioloop=ioloop))
...
class Webhooks(object):
    ...
    def list(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('webhooks/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def add(self, url, description=None, events=[], ioloop=None):
        """Add a new webhook
        ...
        return (yield from self.master.call('webhooks/add', _params, ioloop=ioloop))
    ...
    def info(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('webhooks/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def update(self, id, url, description=None, events=[], ioloop=None):
        ...
        return (yield from self.master.call('webhooks/update', _params, ioloop=ioloop))
    ...
    def delete(self, id, ioloop=None):
        ...
        """
        _params = {'id': id}
        return (yield from self.master.call('webhooks/delete', _params, ioloop=ioloop))
...
class Senders(object):
    ...
    def list(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('senders/list', _params, ioloop=ioloop))
    ...
    def domains(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('senders/domains', _params, ioloop=ioloop))
...
send, but you can use this call to add them ahead of time.
        ...
        """
        _params = {'domain': domain}
        return (yield from self.master.call('senders/add-domain', _params, ioloop=ioloop))
...
account, it will be added automatically.
        ...
        """
        _params = {'domain': domain}
        return (yield from self.master.call('senders/check-domain', _params, ioloop=ioloop))

    @asyncio.coroutine
    def verify_domain(self, domain, mailbox, ioloop=None):
...
other Mandrill accounts from sending mail signed by your domain.
        ...
        return (yield from self.master.call('senders/verify-domain', _params, ioloop=ioloop))

    @asyncio.coroutine
    def info(self, address, ioloop=None):
        ...
        return (yield from self.master.call('senders/info', _params, ioloop=ioloop))

    @asyncio.coroutine
    def time_series(self, address, ioloop=None):
        ...
        """
        _params = {'address': address}
        return (yield from self.master.call('senders/time-series', _params, ioloop=ioloop))
...
class Metadata(object):
    ...
    def list(self, ioloop=None):
        ...
        """
        _params = {}
        return (yield from self.master.call('metadata/list', _params, ioloop=ioloop))

    @asyncio.coroutine
    def add(self, name, view_template=None, ioloop=None):
        ...
        return (yield from self.master.call('metadata/add', _params, ioloop=ioloop))

    @asyncio.coroutine
    def update(self, name, view_template, ioloop=None):
        ...
        """
        _params = {'name': name, 'view_template': view_template}
        return (yield from self.master.call('metadata/update', _params, ioloop=ioloop))
    ...
    def delete(self, name, ioloop=None):
        ...
        """
        _params = {'name': name}
        return (yield from self.master.call('metadata/delete', _params, ioloop=ioloop))
